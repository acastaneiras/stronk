...
export default function BottomNavigation() {
  return (
    <nav className="sticky bottom-0 left-0 right-0 z-50 flex h-14 w-full items-center justify-around bg-background shadow-t dark:bg-background dark:shadow-t-gray-800 border-t md:justify-evenly">
      <Link
        to="/training"
